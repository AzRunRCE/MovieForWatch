// Components/SearchTVShow.js

import React from 'react'
import { StyleSheet, View, TextInput, Button, Text, FlatList, ActivityIndicator } from 'react-native'
import FilmItem from './FilmItem'
import FilmList from './FilmList'
import { getTvShowFromApiWithSearchedText, getPopularTvShowFromApi } from '../API/TMDBApi'

class SearchTVShow extends React.Component {
  ...
  constructor(props) {
    ...
    this._loadPopularTvShow();
  }


  _loadPopularTvShow()
  {
    getPopularTvShowFromApi(this.page+1).then(data => {
        this.page = data.page
